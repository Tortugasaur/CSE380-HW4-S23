...
export default class AStarDemoScene extends Scene {
  ...
  public loadScene(): void {
    this.load.tilemap("level", "hw4_assets/tilemaps/MyTilemap.json");
    this.load.spritesheet(
      "BlueEnemy",
      "hw4_assets/spritesheets/BlueEnemy.json"
    );
  }
  ...
  public startScene(): void {
    ...
    let destination = this.add.graphic(GraphicType.RECT, "primary", {
      position: this.destination,
      size: new Vec2(20, 20),
    });
    destination.color = Color.BLUE;
    destination.color.a = 0.5;
  ...
  public updateScene(deltaT: number): void {
    ...
    //console.log("npc at "+this.npc.position.x+","+this.npc.position.y);
  }
